                ...
                <div class="ui card">
                    ...
                    <div class="content">
                        ...
                        <div class="description">
                            You have logout out successfuly.<br> We wish to have your valuable feedback.<br> Please
                            spare 5 minutes and give your opinion.
                        </div>
                    </div>
                        ...
                        <center>
                            <div class="ui form">
                                <div class="two fields">
                                    ...
                                    <div class="field"><button onclick="window.open('./index.php', '_self');"
                                            class="ui secondary button">Close</button></div>
                                </div>
                        </center>
                    </div>
